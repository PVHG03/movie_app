  ...
  return (
    <>
      <div className="relative h-screen text-white ">
        ...
        <img onLoad={
          () => setImgLoading(false)
        } src={ORIGINAL_IMG_BASE_URL + trending?.backdrop_path} alt="" className="absolute top-0 left-0 w-full h-full object-cover -z-50 " aria-hidden={true} />
        ...
        <div className="absolute top-0 left-0 w-full h-full object-cover -z-50 bg-black/50"  >
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
            ...
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-lg">{trending?.overview.length > 200 ? trending?.overview.slice(0, 200) + "..." : trending?.overview}</p>
            </div>
